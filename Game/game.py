...
def remove_spaces(text):
    ...
    ''
    """
    step_1 = text[count_lspace(text):]
    step_2 = step_1[::-1]
    step_3 = step_2[count_lspace(step_2):]
    step_4 = step_3[::-1]
...
def normalise_input(user_input):
    ...
    'help'
    """
    step_5 = remove_punct(user_input)
    step_6 = remove_spaces(step_5)
    step_7 = step_6.lower()
    return step_7
